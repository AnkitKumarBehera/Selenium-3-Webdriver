...
public class WriteWxcelData {
public static void main(String args[]) throws Exception{ 
	FileInputStream fis = new FileInputStream("D:\\selenium software\\WriteData.xlsx");
...
fis.close();
FileOutputStream fileOut=new FileOutputStream("D:\\selenium software\\WriteData.xlsx");
